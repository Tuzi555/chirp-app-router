    ...
    <header className="h-auto w-full py-4 text-center">
      <div className="flex items-center justify-between space-x-3 px-4 md:mx-12 lg:mx-36 xl:mx-48 2xl:mx-64">
        ...
        <div className="flex flex-row gap-3">
          ...
          <a aria-label="Link to site author's LinkedIn profile " href="https://www.linkedin.com/in/jakub-tuzar/">
            <svg width="44" height="44" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" className="fill-primary">
              <path
      ...
      <h1 className="bg-gradient-to-br from-primary to-pink-500 bg-clip-text text-6xl font-extrabold text-transparent md:text-8xl">
        Chirp
      </h1>
    </header>
  );
